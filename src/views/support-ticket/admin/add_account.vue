        ...
        <CForm novalidate :validated="form.validatedCustom01">
          <CRow class="mb-3">
            <CCol class="header1" >
              ...
              <h1 id="LineHeadCard">
              <CImage class="manage-accounts-image" :src="manage_accounts" alt="Manage Accounts Image"> </CImage> Create New Account</h1>
            </CCol>
          </CRow>
          <CRow class="mb-3">
          ...
          <CRow class="mb-3">
            ...
            <CCol xs="12" md="6" lg="4">
              <CFormLabel for="LnameTH" class="col-sm-12 col-form-label" invalid><b>Last name (Thai)</b><span id="required">* </span>  </CFormLabel>
            ...
            <CCol xs="12" md="6" lg="4">
              <CFormLabel for="FnameEng" class="col-sm-12 col-form-label"><b> First name (English)</b> <span id="required"> *</span>  </CFormLabel>
            ...
            <CCol xs="12" md="6" lg="4">
              <CFormLabel for="LnameEng" class="col-sm-12 col-form-label"><b>Last name (English)</b> <span id="required">* </span> </CFormLabel>
          ...
          <CRow class="mb-3">
            <CCol xs="12" md="6" lg="4">
              ...
              <CFormInput type="email" id="email" name="email" feedbackInvalid="Please input email."  placeholder="example@gmail.com"
            ...
            <CCol xs="12" md="6" lg="4">
              ...
              <CFormInput type="email" id="confirmEmail" name="confirmEmail" feedbackInvalid="Please input confirm email."  placeholder="example@gmail.com"
            ...
            <CCol xs="12" md="6" lg="8">
              ...
              <CFormInput type="number" id="phone" name="phone" feedbackInvalid="Please input your phone number."  placeholder="e.g. 0611234567"
